    ...
    $(document).ready(function() {
        ...
        if ($('#lgx-countdown').length) {
            ...
            $('#lgx-countdown').countdown(dataTime, function(event) {
                var $this = $(this).html(event.strftime('' + '<span class="lgx-days">%D <i> Days </i></span> ' + '<span class="lgx-hr">%H <i> Hour </i></span> ' + '<span class="lgx-min">%M <i> Min </i></span> ' + '<span class="lgx-sec">%S <i> Sec </i></span>'));
            });
        }
